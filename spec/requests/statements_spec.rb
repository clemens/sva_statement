...
RSpec.describe "Statements API", type: :request do
  describe "GET to #parse" do
    ...
    context "when given a PDF file" do
      ...
      it "evaluates the given PDF file (2.pdf)" do
        params = { file: file_from(fixture("2.pdf"), "application/pdf") }
      ...
      it "evaluates the given PDF file (3.pdf)" do
        params = { file: file_from(fixture("3.pdf"), "application/pdf") }
      ...
      it "evaluates the given PDF file (4.pdf)" do
        params = { file: file_from(fixture("4.pdf"), "application/pdf") }
      ...
      it "evaluates the given PDF file (5.pdf)" do
        params = { file: file_from(fixture("5.pdf"), "application/pdf") }
